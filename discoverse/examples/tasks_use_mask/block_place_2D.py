...
if __name__ == "__main__":
    ...
    trmat = Rotation.from_euler("xyz", [0., np.pi/2 - 0.5236, 0.], degrees=False).as_matrix()
        ...
        try:
            if stm.trigger():
                if stm.state_idx == 0: # 伸到方块上方
                    ...
                    tmat_jujube = get_body_tmat(sim_node.mj_data, "block_green")
                    tmat_jujube[:3, 3] = tmat_jujube[:3, 3] + 0.018 * tmat_jujube[:3, 2] + 0.005 * tmat_jujube[:3, 0]
                    tmat_tgt_local = tmat_armbase_2_world @ tmat_jujube
                    sim_node.target_control[:6] = arm_fik.properIK(tmat_tgt_local[:3,3], trmat, sim_node.mj_data.qpos[:6])
...
# <key qpos='-3.67952e-23 -0.661065 0.295714 -1.56882 0.680215 1.57 8.47404e-06 -1.19757e-05 7.26832e-06 0.849993 0.7145 1 2.00643e-17 5.07897e-21 -6.85187e-17 0.0274423 1.25268 0.698825 0.985518 -3.2646e-06 -3.69178e-08 0.169574 0 0'/>
