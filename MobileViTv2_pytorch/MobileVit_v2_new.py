...
import sys
sys.path.append('/home/djr/DISCOVERSE/MobileViTv2_pytorch')
...
class MobileViTv2_New(nn.Module):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        layer_0_dim = int(make_divisible(layer_0_dim, divisor=8, min_value=16)) # d=32
        # 定义MobileViTv2的网络配置
        mobilevit_config = \
        {
        "layer0": {
